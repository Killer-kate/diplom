...
<body class="m-auto">
    ...
    <main>
        ...
        require("../bd/bd.php");
        $id = $_GET['id'];
        $appeals = $mysql->query("SELECT * FROM `reviews` WHERE `id` = '$id'");
        ...
        <div class="contayner contayner-fluid mx-auto mt-5" style="width:30%">
            <form class="p-3 mb-2 bg-dark text-white" method="post" action="modifiedDataReviews.php?id=<?=$id?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" name="status">
                        ...
                        <option value="3">Рассмотрено</option>
                    </select>
                </div>
