...
require("../bd/bd.php");
$id = $_GET['id'];
$pets = $mysql->query("SELECT * FROM `pets` WHERE `id` = '$id'");
$pet = mysqli_fetch_array($pets);
?>
...
<form class="p-3 mb-2 bg-dark text-white" method="post" action="../php/modifiedData.php?id=<?=$id?>" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="name" class="form-control" value="<?=$pet[2]?>">
  </div>
  <div class="mb-3">
    <label class="form-label">Description</label>
    <textarea class="form-control" name="description" style="height: 150px"><?=$pet[3]?></textarea>
  </div>
  <div class="mb-3">
